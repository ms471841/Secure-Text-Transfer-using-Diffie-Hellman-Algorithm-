...
def main():
	...
	global form
	form = tkinter.Tk()
	form.wm_title('Socio Secure text Transfer')
	'''
	-------------------------------------------------------------
	...
	Aboutus.grid(row=4, columnspan=7, \
	...
	-------------------------------------------------------------
	'''	
	intro = Label(Aboutus, text="\nSocio Secure Text Transfer")
	intro.grid(row=0)
	text1 = Label(Aboutus, text="\nEncryption and Decryption of text file\n using Public and private keys\n")
	text1.grid(row=1)
	# githublink = Label(Aboutus, text="Go to Github Repo", fg="blue", cursor="hand2")
